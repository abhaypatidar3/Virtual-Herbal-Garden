  ...
  return (
    ...
    {/* right side */}
        <div className="h-screen w-full sm:w-[60vw] right-0 bg-[url('src/assets/money_plant.jpg')] sm:bg-none">
            <div className="text-[60px] sm:text-[70px] font-itim text-[#306203] mt-[12vh] sm:mt-[22vh] mr-[4vw] flex justify-center w-full mb-0 sm:mb-[30px]">
                <h1>OUR MISSION</h1>
            </div>
            <p className='font-itim text-black text-2xl sm:text-4xl text-center px-[9vw] sm:px-[8vw]'>Our mission is to promote holistic health and wellness by providing high-quality, sustainably sourced Ayurvedic and medicinal plant products. We are dedicated to preserving traditional knowledge while innovating for a healthier tomorrow.</p>
        </div>
